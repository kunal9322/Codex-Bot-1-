...
from CodexRobot import pbot as Jebot
from CodexRobot.pyrogramee.dark import get_arg
...
import aiohttp
from pyrogram import filters
from CodexRobot import pbot as AMELIA
...
@CODEX.on_message(filters.command("deezer"))
